...
<table style="font-family: Josefin Sans;" align="center" >
    ...
    $x=$_SESSION['cname'];
        ...
        $rs = mysqli_query($connect,"select DISTINCT unique_order_id,ordertime from orders where customer_id='$x'");
        while($array=mysqli_fetch_array($rs))
        {
            echo "<tr>";
            echo "<td>$array[0]";
            echo "<td>$array[1]";
            echo "<td><a href=orderhistorycustomer.php?unique_order_id=$array[0]>View Order Details</a>";
        echo "</tr>";
}
...
<br><br><br>
<p align="center"><a href="customerdashboard.php" class="btn btn-primary">Back</a></p>
